...
if __name__ == "__main__":
    ...
    while run:
        ...
        for counterMeasuresSystem in counterMeasuresSystems:
            ...
            counterMeasuresSystem.launchCounterMeasure(counterMeasuresMissiles, actualTime)

        for counterMeasuresMissile in list(counterMeasuresMissiles):
            counterMeasuresMissile.updateObjectivePosition(counterMeasuresSystems[counterMeasuresMissile.counterMeasureSystemId].enemyMissilesAssigned)
            counterMeasuresMissile.goToObjective()
        ...
        print(f'time {round(endTime - startTime,50)}')
